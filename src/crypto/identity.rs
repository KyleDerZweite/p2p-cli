...
impl IdentityManager {
    ...
    /// Get our 128-bit display fingerprint derived from SHA-256.
...
mod tests {
    ...
    fn test_identity_generation() {
        ...
        assert_eq!(fingerprint.chars().filter(|c| *c == '-').count(), 7);
    ...
    fn test_signature_verification() {
        ...
        let is_valid_wrong =
            IdentityManager::verify_signature(&pubkey, b"Wrong message", &signature).unwrap();
