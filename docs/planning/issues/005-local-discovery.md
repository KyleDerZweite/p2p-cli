...
Evidence: invitation-based two-client terminal acceptance and local interface parser tests. [Linux troubleshooting](../../linux.md) explains how to inspect routes, listeners, local firewalls, CGNAT and router forwarding. It also explains why a two-peer WireGuard tunnel can be blocked and is optional.
